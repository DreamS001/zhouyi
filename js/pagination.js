...
html.push("");if(pageIndex>0){html.push("<span class=\"previous\"><a href=\"javascript:;\" page= "+(pageIndex-1)+" data-rec=\"上一页\"></a></span>");}
...
html.push("");html.push("");return html.join("");},bindListener:function(obj,callback,topFlag){var topFlag=topFlag||true;obj.on("click","a",function(){if(typeof callback==="function"){var index=$(this).attr("page");callback(parseInt(index));}
